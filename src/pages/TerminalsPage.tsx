...
const TerminalsPage: React.FC = () => {
  ...
  const terminals: Terminal[] = [
    ...
    {
      id: "sarahs",
      name: t("terminals.sarahs.name"),
      city: t("terminals.sarahs.city"),
      address: t("terminals.sarahs.address"),
      phone: "+99371713777",
      email: "info@htl-tm.com",
      hours: t("terminals.sarahs.hours"),
      capacity: t("terminals.sarahs.capacity"),
      ...
      specializations: [
        t("terminals.sarahs.spec1"),
        t("terminals.sarahs.spec2"),
        t("terminals.sarahs.spec3"),
      ],
    },
    {
      id: "mary",
      ...
      services: ["freight", "warehousing", "road", "security", "railway"],
      specializations: [
    ...
    },
    {
      ...
      coordinates: { lat: 40.0225, lng: 52.9553 },
      images: [
        // "/images/turkmenbashi/turkmenbashi_1.jpeg",
        // "/images/turkmenbashi/turkmenbashi_2.jpeg",
        // "/images/turkmenbashi/turkmenbashi_3.jpeg",
        // "/images/turkmenbashi/turkmenbashi_4.jpeg",
        // "/images/turkmenbashi/turkmenbashi_5.jpeg",
      ],
      services: [
        "freight",
        "warehousing",
